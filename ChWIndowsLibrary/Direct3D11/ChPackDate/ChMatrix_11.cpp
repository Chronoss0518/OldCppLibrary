...
ChMatrix::operator const DirectX::XMFLOAT4X4()const
{
	ChMatrix_11 TmpMat;
...
ChMatrix::operator const DirectX::XMFLOAT4X4*()const
{
	...
	return reinterpret_cast<DirectX::XMFLOAT4X4*>(const_cast<ChMat*>(this));
}

ChMatrix& ChMatrix::operator= (const DirectX::XMFLOAT3& _Vec)
{
...
ChMatrix& ChMatrix::operator= (const DirectX::XMFLOAT4& _Qua)
{
	ChMat_11 TmpMat;
...
ChMatrix& ChMatrix::operator= (const DirectX::XMFLOAT4X4& _Mat)
{
	for (unsigned char i = 0; i < 4; i++)
	{
		for (unsigned char j = 0; j < 4; j++)
