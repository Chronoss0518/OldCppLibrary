...
namespace ChCpp
{
	class ModelCreater;
	 ...
	 typedef class BaseModel :public  ChCpp::ChCp::InitPack
	{
	public:
	...
	public:
		...
		inline std::vector<ChPtr::Shared<BaseModel::Frame>>& ModelDataIns()
		{
	...
	private:
		...
		inline void Init(const BaseModel* _Model) { Model = const_cast<BaseModel*>(_Model); }
