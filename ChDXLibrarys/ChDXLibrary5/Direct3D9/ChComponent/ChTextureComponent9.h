...
#include"../../CPP/ChBaseObject/ChBaseObjectParts.h"
...
typedef class ChSpriteTextureComponent9 :public ChTexCom9,public ChCpp::OP_Draw
{
public:
...
typedef class ChPolygonTextureComponent9 :public ChTexCom9,public ChCpp::OP_Draw
{
public:
