...
typedef class ChModelComponent9 :public ChCpp::BaseComponent,public ChCpp::OP_Draw
{
public:
...
typedef class ChSkinMeshModelComponent9 :public ChModelCom9,ChCpp::OP_Update
{
public:
